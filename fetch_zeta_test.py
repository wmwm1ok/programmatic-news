#!/usr/bin/env python3
"""
专门抓取 Zeta Global 的测试脚本
Zeta 日期在 evergreen-item-date-time / evergreen-news-date 类中
格式: "February 10, 2026"
类似于 AppLovin 结构
时间窗口: 14天内
"""
...
print("="*70)
print("Zeta Global 专门抓取 - 最近14天")
print("URL: https://investors.zetaglobal.com/news/default.aspx")
print("="*70)
...
print(f"策略: 从列表页提取日期(evergreen-item-date-time类)，进入详情页获取内容\n")
...
with sync_playwright() as p:
    ...
    try:
        print("[2] 访问 Zeta Global Investors 页面...")
        page.goto(url, wait_until="domcontentloaded", timeout=120000)
        page.wait_for_timeout(5000)
        print("    ✓ 页面加载完成")
        
        print("[3] 保存截图...")
        page.screenshot(path='zeta_page.png', full_page=True)
        print("    ✓ 截图已保存: zeta_page.png")
        
        html = page.content()
        soup = BeautifulSoup(html, 'html.parser')
        
        print("\n[4] 查找 evergreen-item-date-time 日期元素...")
...
if items:
    ...
    try:
        ...
        competitor_data = {"Zeta Global": items}
